 ...
 */
final class Version20240916084936 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE news (id INT IDENTITY NOT NULL, titre NVARCHAR(50) NOT NULL, contenu NVARCHAR(255) NOT NULL, datenews DATE NOT NULL, image NVARCHAR(255), PRIMARY KEY (id))');
